...
const socialProfiles: Record<string, SocialProfile> = {
  GitHub: {
    name: "Phuc",
    handle: "Phucmh98 · he/him",
    avatar: "https://github.com/Phucmh98.png",
    bio: "Civil Engineer / Developer",
    location: "Ho Chi Minh City, Vietnam (UTC +07:00)",
    stats: [
      { value: "1", label: "followers" },
      { value: "1", label: "fllowing" },
    ],
  },
  Twitter: {
    name: "Phuc",
    handle: "@phuc_dev_98",
    avatar: "https://unavatar.io/x/phuc_dev_98",
    banner: darkBannerImage,
    bio: "Civil Engineer / Developer",
    location: "Ho Chi Minh City, Vietnam (UTC +07:00)",
    stats: [
      { value: "30", label: "Following" },
      { value: "538", label: "Followers" },
    ],
  },
  LinkedIn: {
    name: "Phuc",
    handle: "in/mhphuc98",
    avatar: "https://unavatar.io/linkedin/mhphuc98",
    banner: darkBannerImage,
    bio: "Front-End Developer | NextJs/ReactJs | Webpack | 3D View | CDE BIM",
    location: "Ho Chi Minh City, Vietnam (UTC +07:00)",
    stats: [{ value: "417", label: "Connections" }],
  },
          ...
          <HoverCard.Portal forceMount>
            ...
            >
              <motion.div
                ...
                className={cn(
                  "w-57.5 sm:w-62.5 rounded-xl shadow-2xl backdrop-blur-md overflow-hidden",
                ...
                {socialName === "GitHub" || socialName === "Discord" ? (
                  ...
                  <>
                    ...
                    {profile.banner ? (
                      ...
                      <div className="relative w-full h-9 bg-linear-to-r from-zinc-100 to-zinc-200 dark:from-zinc-900 dark:to-zinc-950 border-b border-black/5 dark:border-white/5" />
                    )}
                    ...
                    <div className="p-3.5 pt-0">
                      ...
                      <div className="mt-2.5">
                        <p className="text-[12px] leading-4 text-zinc-600 dark:text-zinc-300 font-sans">
                          {profile.bio}
                        </p>
                      </div>
