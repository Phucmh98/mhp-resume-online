  ...
  return (
    <>
      ...
      <div className="relative pt-6 pb-12 px-4">
        ...
        />
        {/* Intersections */}
        <div className="absolute bottom-0 left-0 w-0.5 h-0.5 bg-black/50 dark:bg-white/25 -translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
        <div className="absolute bottom-0 right-0 w-0.5 h-0.5 bg-black/50 dark:bg-white/25 translate-x-1/2 translate-y-1/2 pointer-events-none z-20" />
